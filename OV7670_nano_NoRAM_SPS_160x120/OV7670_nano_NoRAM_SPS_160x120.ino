...
#include <stdint.h>
#include <avr/io.h>
#include <util/twi.h> // Дефайны TWI
...
const struct RegVal QVGA_OV7670[] PROGMEM = {
  { REG_COM14,        0x19 }, // DCW and scaling PCLK | Divided by 2 | Manual scaling enable
  { SCALING_DCWCTR,   0x11 }, // Horizontal down sample by 2 | Vertical down sample by 2
  { SCALING_PCLK_DIV, 0xf1 }, // Clock divider by 2
  { REG_HSTART,       0x16 }, // Horizontal Frame start high 8-bit
  { REG_HSTOP,        0x04 }, // Horizontal Frame end high 8-bit
  { REG_HREF,         0xa4 }, // Horizontal Frame start low 3 bits & end low 3 bits
  { REG_VSTART,       0x02 }, // Vertical Frame start high 8-bit
  { REG_VSTOP,        0x7a }, // Vertical Frame end high 8-bit
  { REG_VREF,         0x0a }, // Vertical Frame start low 3 bits & end low 3 bits
...
//---------------------------------------------------------------------------------
const struct RegVal QCIF_OV7670[] PROGMEM = { //SPS IN PROCEss !
  { REG_COM14,        0x19 }, // DCW and scaling PCLK | Divided by 2 | Manual scaling enable
  { SCALING_DCWCTR,   0x22 }, // Horizontal down sample by 2 | Vertical down sample by 2
  { SCALING_PCLK_DIV, 0xf1 }, // Clock divider by 2
  { REG_HSTART,       0x16 }, // Horizontal Frame start high 8-bit
  { REG_HSTOP,        0x04 }, // Horizontal Frame end high 8-bit
  { REG_HREF,         0xa4 }, // Horizontal Frame start low 3 bits & end low 3 bits
...
void setup() {
  ...
  wrReg(REG_CLKRC, 31);   // Выставляем предделитель             
}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////// ОСНОВНЫЙ ЦИКЛ /////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
void setResolution(void){
  wrReg(REG_COM3, 4);                                       // Разрешаем доунсемплинг и обрезку
 // wrSensorRegs(QVGA_OV7670);                              // Формат QVGA  320x240
  wrSensorRegs(QQVGA_ov7670);                               // Формат QQVGA  160x120
  
 //   wrReg(REG_COM3, 0x8);                                 // Разрешаем масштабирование
 //   wrReg(REG_COM7, 0x8);                                 // Выбираем QCIF                        
}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void setColor(void){
