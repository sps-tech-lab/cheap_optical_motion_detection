...
begin
if data[1]=0 then MoveChb.Checked:=false else MoveChb.Checked:=true;
Edit_DX.Text:=inttostr(data[2]);
Edit_DY.Text:=inttostr(data[3]);
Edit_SQ.Text:=inttostr(data[4]);
Edit_PMX.Text:=inttostr(data[7]);
end;
