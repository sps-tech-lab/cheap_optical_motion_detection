...
var
px,py,xg,yg,scale,brg,pos : Integer;
begin
...
begin
  ...
  ////////////////////////////////
    ...
    begin
      ...
      begin
        PaintBox1.Canvas.Pixels[px+(16-xg)*scale,py+(16-yg)*scale]:=RGB(data[pos]*brg,data[pos]*brg,data[pos]*brg);
      end;
    end;
  ////////////////////////////////
  inc(pos);
...
for pos:=0 to 225 do data[pos]:=0;
...
var
  u : Integer;
begin
     for u:=1 to 225 do    data[u] :=Random(64);  // Имитация камры
...
var
px,py,xg,yg,scale,brg,color : Integer;
begin
scale:=ScaleBar.Position;
brg:=Bright.Position;
color:=00;
...
begin
  for yg:=1 to 15 do
  begin
//  PaintBox1.Canvas.Pixels[xg,yg]:=RGB(color,color,color);
 // color:=color+1;
  ////////////////////////////////
    for px:=1 to scale do
    begin
      for py:=1 to scale do
      begin
        PaintBox1.Canvas.Pixels[px+(16-xg)*scale,py+(16-yg)*scale]:=RGB(color,color,color);
      end;
    end;
  ////////////////////////////////
  inc(color);
